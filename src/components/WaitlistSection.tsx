...
import { Fire, Shield, TrendUp, ChevronDown } from 'phosphor-react';
    ...
    <section id="waitlist" className="py-16 bg-gradient-to-br from-primary-50 to-white">
      <div className="container-width section-padding">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-light tracking-tight text-gray-900 mb-6 animate-fade-in">
            Why Join the Waitlist Now
          </h2>
          
          <p className="text-lg text-gray-700 mb-8 leading-relaxed animate-slide-up">
          ...
          <div className="glass-card p-6 animate-slide-up">
            ...
            <p className="text-sm text-gray-500 opacity-80 mt-3">
